...
export default {
   ...
   websiteDescription:
      "This website is inspired by the design of GitHub. Feel free to explore and check out my projects. If you have any questions or just want to chat, don't hesitate to reach out!",
} satisfies About
