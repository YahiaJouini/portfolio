...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  `)
   await db.run(
      sql`CREATE INDEX \`projects_languages_order_idx\` ON \`projects_languages\` (\`_order\`);`,
   )
   await db.run(
      sql`CREATE INDEX \`projects_languages_parent_id_idx\` ON \`projects_languages\` (\`_parent_id\`);`,
   )
  ...
  `)
   await db.run(
      sql`CREATE INDEX \`projects_topics_order_idx\` ON \`projects_topics\` (\`_order\`);`,
   )
   await db.run(
  ...
  `)
   await db.run(
      sql`CREATE INDEX \`projects_roles_order_idx\` ON \`projects_roles\` (\`_order\`);`,
   )
   await db.run(
      sql`CREATE INDEX \`projects_roles_parent_id_idx\` ON \`projects_roles\` (\`_parent_id\`);`,
   )
  ...
  `)
   await db.run(
      sql`CREATE INDEX \`projects_summary_values_order_idx\` ON \`projects_summary_values\` (\`_order\`);`,
   )
   await db.run(
      sql`CREATE INDEX \`projects_summary_values_parent_id_idx\` ON \`projects_summary_values\` (\`_parent_id\`);`,
   )
  ...
  `)
   await db.run(
      sql`CREATE INDEX \`projects_summary_order_idx\` ON \`projects_summary\` (\`_order\`);`,
   )
   await db.run(
      sql`CREATE INDEX \`projects_summary_parent_id_idx\` ON \`projects_summary\` (\`_parent_id\`);`,
   )
  ...
  `)
   await db.run(
      sql`CREATE INDEX \`projects_images_order_idx\` ON \`projects_images\` (\`_order\`);`,
   )
   await db.run(
      sql`CREATE INDEX \`projects_images_parent_id_idx\` ON \`projects_images\` (\`_parent_id\`);`,
   )
   await db.run(
      sql`CREATE INDEX \`projects_images_image_idx\` ON \`projects_images\` (\`image_id\`);`,
   )
  ...
  `)
   await db.run(
      sql`CREATE UNIQUE INDEX \`projects_images_locales_locale_parent_id_unique\` ON \`projects_images_locales\` (\`_locale\`,\`_parent_id\`);`,
   )
  ...
  `)
   ...
   await db.run(
      sql`CREATE INDEX \`projects_thumbnail_idx\` ON \`projects\` (\`thumbnail_id\`);`,
   )
   await db.run(
  ...
  `)
   await db.run(
      sql`CREATE INDEX \`blog_tags_order_idx\` ON \`blog_tags\` (\`_order\`);`,
   )
   await db.run(
      sql`CREATE INDEX \`blog_tags_parent_id_idx\` ON \`blog_tags\` (\`_parent_id\`);`,
   )
  ...
  `)
   await db.run(
      sql`CREATE INDEX \`blog_sections_order_idx\` ON \`blog_sections\` (\`_order\`);`,
   )
   await db.run(
      sql`CREATE INDEX \`blog_sections_parent_id_idx\` ON \`blog_sections\` (\`_parent_id\`);`,
   )
  ...
  `)
   await db.run(
      sql`CREATE UNIQUE INDEX \`blog_sections_locales_locale_parent_id_unique\` ON \`blog_sections_locales\` (\`_locale\`,\`_parent_id\`);`,
   )
  ...
  `)
   ...
   await db.run(
      sql`CREATE INDEX \`blog_thumbnail_idx\` ON \`blog\` (\`thumbnail_id\`);`,
   )
   await db.run(
  ...
  `)
   await db.run(
      sql`CREATE UNIQUE INDEX \`blog_locales_locale_parent_id_unique\` ON \`blog_locales\` (\`_locale\`,\`_parent_id\`);`,
   )
